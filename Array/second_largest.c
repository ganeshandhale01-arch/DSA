...
int main(void) 
{
    ...
    {
        printf("No second largest element found %d\n\n", ret);
    }
    ...
    printf("=== Test 2: Array with Duplicates ===\n");
    printf("Array: ");
    printArray(arr2, size2);
    ret = secondLargest(arr2, size2);
    if (ret != INT_MIN)
    {
        printf("Second largest: %d\n\n", ret);
    }
    ...
    int arr3[] = {10, 10, 10};
    size_t size3 = ARRAY_SIZE(arr3);

    printf("=== Test 3: All Identical Elements ===\n");
    printf("Array: ");
    printArray(arr3, size3);
    ret = secondLargest(arr3, size3);
    if (ret != INT_MIN)
    {
        printf("Second largest: %d\n\n", ret);
    }
